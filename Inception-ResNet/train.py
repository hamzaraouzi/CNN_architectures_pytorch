...
from Inception_ResnetV2 import Inception_ResnetV2
...
def main():
    ...
    model = Inception_ResnetV2(in_channels=config.IN_CHANNELS, num_classes=config.NUM_CLASSES).to(device=config.DEVICE)
